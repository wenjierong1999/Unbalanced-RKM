...
'''
Ablation study on different minority classes on 012MNIST
...
for unbalanced_classes in unbalanced_classes_list:
...
expr_df['unbalanced_classes'].astype(str)
expr_df_grouped = expr_df.groupby(['model_name','unbalanced_classes']).agg(['mean', 'std'])
