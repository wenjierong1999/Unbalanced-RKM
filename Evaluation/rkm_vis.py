...
def rkm_latentspace_vis(rkm_model, dataloader : DataLoader):
    '''
...
# rkm_model = torch.load('../SavedModels/PrimalRKM_bMNIST456_1716714891_s10_b300.pth', map_location=torch.device('cpu'))
# #print(rkm_model['PreImageMapNet'])
# rkm_random_generation_vis(rkm_model, 10, 5)
# #rkm_reconsturction_vis(rkm_model, b_MNIST456, 10, per_mode=True)
# rkm_latentspace_vis(rkm_model, b_MNIST456)